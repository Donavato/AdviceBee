...
$(document).ready(function () {
    ...
    $.ajax({
        url: "http://13.59.122.228/api/Advice/listadvices.php",
        type: "POST",
        dataType: "json",
        data: dataString,
    ...
    // Display question
    $.ajax({
        url: "http://13.59.122.228/api/Advice/Advice.php",
        type: "POST",
        dataType: "json",
        data: dataString,
        //on success it will call this function
    ...
    function GetMultiple(){
        ...
        /////LIST ADVICES GIVEN FOR EACH PARTICULAR QUESTION/////////////////////////
        $.ajax({
            url: "http://13.59.122.228/api/Advice/multipleChoices.php",
            type: "POST",
            dataType: "json",
            data: dataString,
            //on success it will call this function
    ...
    $('#submit').on('click', function (e) {
        ...
        else
        {
            ...
            //Send answer to DB
            $.ajax({
                url: "http://13.59.122.228/api/Advice/giveAdvice.php",
                type: "POST",
                dataType: "json",
                data: dataString,
                success: function (data) {
