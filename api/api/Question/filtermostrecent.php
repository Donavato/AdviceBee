<?php
    ...
    //IF TOPIC ID DOESNT EXIST PROCEED WITH NORMAL DISPLAYING WITH FILTERING BY DATE DESCENDING
    if(!$tID){
        
        //FETCH ALL QUESTIONS FROM QUESTIONS TABLE BY DATE, ALSO CREATE TEMP TABLE FROM ADVICE AND STORE AS COMMENTCOUNT
    ...
    //IF TOPIC ID EXIST
        ...
        while($h = mysqli_fetch_object($t_query)){
            ...
            //FETCH ALL QUESTIONS FROM QUESTIONS TABLE WITH SELECTED TOPIC ORDERED BY DATE, ALSO CREATE TEMP TABLE FROM ADVICE AND STORE AS COMMENTCOUNT
