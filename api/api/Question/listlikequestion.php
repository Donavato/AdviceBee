...
//SELECT ALL DATA FROM LIKE QUESTIONS TABLE WITH USERID
...
while($a = mysqli_fetch_object($datastring)){
    ...
    //FETCH ALL QUESTIONS FROM QUESTIONS TABLE, ALSO CREATE TEMP TABLE FROM ADVICE AND STORE AS COMMENTCOUNT
